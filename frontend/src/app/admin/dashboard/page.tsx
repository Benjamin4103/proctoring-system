        ...
        <div className="bg-white rounded-xl shadow-sm overflow-hidden">
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-gray-50">
              {sessions.length === 0 && (
                <tr><td colSpan={5} className="px-5 py-8 text-center text-gray-400">No sessions yet</td></tr>
              )}
              {sessions.map((s) => (
                  ...
                  <td className="px-5 py-4">
                    <div className="flex items-center gap-2">
                      <div className="w-24 bg-gray-100 rounded-full h-1.5">
                        <div
                          className={`h-1.5 rounded-full ${s.suspicion_score > 70 ? 'bg-red-500' : s.suspicion_score > 45 ? 'bg-orange-400' : s.suspicion_score > 20 ? 'bg-yellow-400' : 'bg-green-400'}`}
